...
namespace FaceQuickstart
{
    class Program
    {
        ...
        static readonly string SubscriptionKey = Environment.GetEnvironmentVariable("FACE_API") ?? "<apikey>";
        static readonly string Endpoint = Environment.GetEnvironmentVariable("FACE_API_ENDPOINT") ?? "https://facehein.cognitiveservices.azure.com/";
